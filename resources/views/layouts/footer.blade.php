    ...
    <div class="max-w-6xl m-auto text-gray-800 flex flex-wrap justify-center">
        ...
        <div class="p-5 w-48 ">
            ...
            <a class="my-3 block" href="/#">Sign in <span class="text-teal-600 text-xs p-1"></span></a><a
                ...
                class="my-3 block" href="/#">Career <span class="text-teal-600 text-xs p-1">We're hiring</span></a><a
                class="my-3 block" href="/#">Surveys <span class="text-teal-600 text-xs p-1">New</span></a>
        </div>
        <div class="p-5 w-48 ">
...
<div class="bg-gray-100 pt-2 ">
    <div class="flex pb-5 px-3 m-auto pt-5 border-t text-gray-800 text-sm flex-col
       md:flex-row max-w-6xl">
        <div class="mt-2">&copy; Copyright 2021. All Rights Reserved.</div>
