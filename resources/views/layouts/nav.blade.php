 <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
     ...
     <ul
         ...
         <li><a class="nav-link text-sm text-gray-400 hover:text-gray-500" href="{{ route('home-page') }}">Home</a>
         </li>
         ...
         <li><a class="nav-link text-sm text-gray-400 hover:text-gray-500" href="{{ route('room.index') }}">Rooms</a>
         </li>
         <li class="text-gray-300">
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
                 viewBox="0 0 24 24">
         ...
         <li><a class="nav-link text-sm text-gray-400 hover:text-gray-500" href="#">Services</a></li>
         <li class="text-gray-300">
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
                 viewBox="0 0 24 24">
                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
         ...
         <li><a class="nav-link text-sm text-gray-400 hover:text-gray-500" href="#">About Us</a></li>
         <li class="text-gray-300">
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
                 viewBox="0 0 24 24">
                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
 ...
 <div class="navbar-menu relative z-50 hidden">
     ...
     <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
         ...
         <div>
             <ul>
                 <li class="mb-1">
                     <a class="nav-link block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
                         href="{{ route('home-page') }}">Home</a>
                 </li>
                 <li class="mb-1">
                     <a class="nav-link block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
                         href="{{ route('room.index') }}">Rooms</a>
                 </li>
                 <li class="mb-1">
                     <a class="nav-link block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
                         href="#">Services</a>
